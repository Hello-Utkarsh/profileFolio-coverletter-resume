...
export default function CoverLetter() {
  ...
  const message =
    'Mable AI is hiring a Senior GoLang Developer ($40k-$50k, 0.1%-0.3% equity) to design, implement, and maintain backend systems, conduct code reviews, optimize architecture, collaborate with TypeScript front-end and AWS teams, and mentor junior developers. Requirements: 5+ years GoLang, TypeScript, AWS, large-scale applications, relational/non-relational databases, strong problem-solving and communication skills. Compensation: $46K USD/year plus bonuses and stock options. Join Mable AI to revolutionize e-commerce tracking with our no-code solution, backed by 15+ investors, serving 100+ B2B customers globally, with opportunities for professional development, innovation, international exposure, milestone-based bonuses, ownership through ESOPs, and a tech pack (latest MacBook or similar). Apply now!';
