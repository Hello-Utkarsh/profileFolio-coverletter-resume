        ...
        <div className="w-9/12 mx-2 flex flex-col">
          <div className="bg-[#a8c7e0] rounded-md px-4 pr-8 py-3">
            ...
            <div className="flex justify-between">
              ...
              <p className="font-semibold text-lg underline cursor-pointer tracking-tighter">
                Why!?
              </p>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3 my-4">
            <div className="bg-slate-100 rounded-lg py-3 px-4">
              ...
              <p className="text-sm">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime at aliquid quisquam
                velit ducimus eos.
              </p>
            </div>
            <div className="bg-slate-100 rounded-lg py-3 px-4">
